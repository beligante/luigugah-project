...
public class MainTest {
    ...
    public static void main(String[] args) throws Exception {
		...
		final LeagueConnection c = new ConnectionManager().getLeagueConnection(LeagueServer.BRAZIL, user, password, gameVersion);
		final String SUMMONER_TO_LOOK_UP = "Shadow of knight";
