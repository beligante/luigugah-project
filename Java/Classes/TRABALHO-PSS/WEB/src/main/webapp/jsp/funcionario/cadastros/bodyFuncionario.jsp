...
<form class="form-horizontal" role="form">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			...
			<label>
				<input type="radio" name="optionsRadios" id="optionsRadios1" value="F" checked> Feminino
			</label>
		</div>
	</div>
	...
	<div class="form-group">
		<label for="inputName" class="col-sm-2 control-label">Salario</label>
		<div class="col-xs-5">
	...
	<div class="form-group">
		<label for="inputName" class="col-sm-2 control-label">Cota</label>
		<div class="col-xs-5">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<button type="submit" class="btn btn-default">Cadastrar Funcionario</button>
		</div>
	</div>
</form>